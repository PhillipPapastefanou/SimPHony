...
sapflux_file = os.path.join(root_data_path, 'hainich', 'eval', 'SAP_Hainich_Fagus-mean_dT30min_prog_jul.csv')
...
theta_s =  5.24650019e-01
theta_r =  2.53302586e-02
pore_size_ind =  5.66495539e-01
tree_density = 3.02644654e-03 * 1.2
leaf_hydraulic_capacitance  = 1.25219301e-01
k_xylem_sat = 3.30929933e+01 * 1.4
g_bark =  1.50871324e-02 * 1
params.g0 =  0.01

init= {}
init['theta_s'] = theta_s
init['theta_r'] = theta_r
init['pore_size_ind'] = pore_size_ind
#init['k_soil_sat'] =soil_layers[0].k_soil_sat
init['g_bark'] =g_bark
# init['psi_leaf_50_close'] = params.psi_leaf_50_close
# init['d_50_close'] = params.d_50_close
init['tree_density'] = tree_density
init['kappa_l'] = leaf_hydraulic_capacitance
init['k_xylem_sat'] = k_xylem_sat

minf = 0.8
maxf = 1.2
bounds = {}
bounds['theta_s'] = (theta_s* minf, theta_s* maxf)
bounds['theta_r'] =  (theta_r* minf, theta_r* maxf)
bounds['pore_size_ind'] = (pore_size_ind* minf, pore_size_ind* maxf)
#bounds['k_soil_sat'] = (soil_layers[0].k_soil_sat * 0.5, soil_layers[0].k_soil_sat * 2.0)
bounds['g_bark'] = (g_bark* minf, g_bark* maxf)
...
bounds['tree_density'] = (tree_density* minf, tree_density* maxf)
bounds['kappa_l'] =(leaf_hydraulic_capacitance* minf, leaf_hydraulic_capacitance* maxf)
bounds['k_xylem_sat'] = (k_xylem_sat* minf, k_xylem_sat* maxf)
