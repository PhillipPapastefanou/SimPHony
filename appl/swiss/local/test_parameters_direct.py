...
parameter_file = os.path.join("/Users/pp/data/Simulations/A08_SimPHony/swiss/u_all/post/parameters_best_mean_alive.csv")
parameter_parser = Parameter_Parser()
# Specify number of rows to not read in the whole file
parameter_parser.Read_Parameter_List(parameter_file, nrows= 10)

# Obtain one parameter setup of the list
parameters = parameter_parser.parameters_list[9]

# Change parameters here --------
parameters.k_xylem_sat = 40
parameters.stem_hydraulic_capacitance = 50 * 1000/18
parameters.wcont_sigma_deviation = 1
...
soil_layers[0].k_soil_sat = 2E-6
soil_layers[1].k_soil_sat = 2E-6
soil_layers[2].k_soil_sat = 2E-6
