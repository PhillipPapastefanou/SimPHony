...
root_library_path = '/Users/pp/Documents/Repos/p_hydro/plant_hydro_standalone'
path = os.path.join(root_library_path,'src','contrib',
                    'param_generation', 'LHS', 'generator_files')
...
plist.Write_Full_Parameter_File(f"{path}/Hainich_parameters_{ncombs}.csv")
