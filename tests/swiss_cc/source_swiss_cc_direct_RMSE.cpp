...
TEST(Swiss_cc_tests, Apply_model_from_file_RMSE) {
    ...
    config.parameters_list_file.value = "/Users/pp/data/Simulations/A08_SimPHony/swiss/11_06_nstdn_change_1E7/post/parameters_best_6.csv";
