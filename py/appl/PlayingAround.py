...
from src.py.Leaf_Stem_Coupled_DiffPsiGL import ML_Leaf_Stem_SemiCoupled_Module
...
params.k_soil_sat = 3/100.0/3600.0
params.k_soil_sat = 1/100.0/3600.0
params.theta_s = 0.43
params.camp_b = 4.5

params.tree_dens = 431/10000.0 # Sharaths nature reference
...
ax.plot(df['T'] * molH20Togram / params.tree_dens, label = 'T')
ax.plot(df['J'] * molH20Togram / params.tree_dens, label = 'J')
ax.plot(df['G'] * molH20Togram / params.tree_dens, label = 'G')
ax.legend()
ax.set_xlabel("Time")
